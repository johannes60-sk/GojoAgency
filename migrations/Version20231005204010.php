 ...
 */
final class Version20231005204010 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE property_search (id INT AUTO_INCREMENT NOT NULL, max_price INT NOT NULL, min_surface INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
